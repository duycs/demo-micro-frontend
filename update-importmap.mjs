...
const url = `https://demo-micro-frontends.s3-us-west-2.amazonaws.com/%40orgName/master-nav/${process.env.TRAVIS_COMMIT}/master-nav.js`;
  ...
  .get(url, res => {
    ...
    if (res.statusCode >= 200 && res.statusCode < 300) {
      if (
        ...
        const moduleName = `@orgName/master-nav`;
